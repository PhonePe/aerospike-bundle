...
@Slf4j
public class PrimaryBatchRecordSequenceListener<T> implements BatchRecordSequenceListener {
    ...
    public PrimaryBatchRecordSequenceListener(final BatchRecordSequenceListener originalListener,
    ...
    public void onRecord(BatchRecord batchRecord, int i) throws AerospikeException {
        originalListener.onRecord(batchRecord, i);
    }
